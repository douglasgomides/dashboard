  ...
  component: () => (
    <PhasePlaceholder
      ...
      description={
        ...
        "Toda ação automática fica registrada em log com o motivo — nunca uma caixa-preta. As ações reais de pausa/orçamento já existem na Windsor.ai (Meta Ads); esta tela vira o construtor de condições por cima delas."
      }
    />
  ),
});
